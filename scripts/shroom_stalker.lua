...
local mushroomData = {
  ...
  },
  {
    ...
    stop = "11:30AM",
    shroomdarId = "CF",
    notes = "Habitat: In rolling green hills or a larger hill or plateau.\n\nSpawner: Groups of 5, a cycler of small spawn then medium spawn then maybe larger spawn up to 100+ then smaller spawn. Spawns migrate. Comes back at a random time after maybe 1 to 2 weeks or so.",
  },
  {
    name = "Crows Beak",
    start = "6:00AM",
  ...
  },
  {
    ...
    stop = "9:35PM",
    shroomdarId = "FL",
    notes = "Habitat: Generated by the opening of bullet furnaces\n\nSpawner: Groups of 4, can be a single to huge numbers of 1000+ depending on how many bullet furnaces fired. \n\nTip: Use eco_killer.lua for 100 rounds, then come back in 16 hours.",
  },
  {
    name = "Fruit of Horus",
    start = "6:00AM",
  ...
  },
  {
    ...
    stop = "11:45AM",
    shroomdarId = "NC",
    notes = "Habitat: Among hilly grassy areas\n\nSpawner: Cycler of several to many for maybe 3-6 shroom times then takes 2 to 3 weeks to return.",
  },
  {
    name = "Nile Fire",
    start = "12:00PM",
  ...
  },
  {
    ...
    stop = "10:35PM",
    shroomdarId = "RE",
    notes = "Habitat: Next to shorter or taller 90 degree strip edges of rock.\n\nSpawner: Groups of ?, a cycler of small spawn then medium spawn then maybe huge spawn up to 300+ then smaller spawn. Comes back at a random time after maybe 1 to 2 weeks or so.",
  },
  {
    ...
    stop = "12:35AM",
    shroomdarId = "SW",
    notes = "Habitat: Spawns in same peninsula and island areas as Heaven's Torrent.\n\nSpawner: Spawns a few to 40+ in a cycle of a few consecutive shroom times then disappears for 1 to 3 weeks.",
  },
  {
    name = "Sand Spore",
    start = "8:00AM",
  ...
  },
  {
    ...
    stop = "9:35PM",
    shroomdarId = "SC",
    notes = "Habitat: Near Persephones, Blast and Compression furnaces.\n\nSpawner: Spawns when ecology is changed enough by use of certain furnaces.Tip: Use eco_killer.lua for 100 rounds, then come back in 16 hours.",
  },
  {
